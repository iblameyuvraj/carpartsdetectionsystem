...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Fast & Accurate Automotive Parts Identification"}
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Upgrade Your Workshop with Advanced Part Detection Technology. <span className="hidden sm:inline">Orbit-The Smartest Way to Identify & Manage Car Parts.</span>
                </p>
            </Container>
            <Container delay={0.2}>
